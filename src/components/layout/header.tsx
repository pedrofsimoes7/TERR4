...
export function Header() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex min-h-[calc(5.5rem+env(safe-area-inset-top))] max-w-7xl items-center justify-between px-6 pt-[env(safe-area-inset-top)] md:h-[5.5rem] md:min-h-0 md:pt-0">
