          ...
          <>
            ...
            >
              <div className="pointer-events-none absolute inset-0 opacity-[0.03] mix-blend-overlay"
                style={{ backgroundImage: "radial-gradient(circle, rgba(255,255,255,.5) 0 1px, transparent 1px)", backgroundSize: "18px 18px" }} />
              ...
              <div className="relative flex items-center justify-between border-b border-white/8 px-6 py-5">
                <Link href="/" onClick={() => setOpen(false)}>
                  <Image src="/images/terr4-logo-assets/terr4-logo-white-transparent.png" alt="TERR4" width={120} height={30} className="object-contain" />
                </Link>
                <motion.button
              ...
              <nav className="relative flex flex-1 flex-col justify-center px-8 py-8">
                {nav.map((item, i) => (
                  <motion.div
                    key={item.href}
                  ...
                  >
                    <Link href={item.href} onClick={() => setOpen(false)}
                      ...
                      <div className="flex items-baseline gap-4">
                        ...
                        <span className="text-[2rem] font-black leading-none tracking-[-0.03em] text-white transition-colors duration-200 group-hover:text-[#f4efe4]">
                          {item.label}
                        </span>
                      </div>
                      <motion.div
              ...
              >
                <Link href="/alugueres" onClick={() => setOpen(false)}
